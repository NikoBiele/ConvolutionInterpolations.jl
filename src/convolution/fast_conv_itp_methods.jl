# Auto-generated concrete conv_itp methods for full type inference.
# Do not edit manually — regenerate with generate_conv_itp_methods.jl
...
function convolution_interpolation(knots::NTuple{2,AbstractVector}, values::Array{T,2}) where {T}
    ...
    return ConvolutionExtrapolation(
        _build_fast_uniform_convolution(knots_t, values,
            ((:detect, :detect), (:detect, :detect)), 101, false,
...
function convolution_interpolation(knots::NTuple{3,AbstractVector}, values::Array{T,3}) where {T}
    ...
    return ConvolutionExtrapolation(
        _build_fast_uniform_convolution(knots_t, values,
            ((:detect, :detect), (:detect, :detect), (:detect, :detect)), 10000, false,
            Val((:b5, :b5, :b5)), Val(false), Val((0, 0, 0)), Val((:linear, :linear, :linear))),
        Throw())
end
...
function convolution_interpolation(knots::NTuple{4,AbstractVector}, values::Array{T,4}) where {T}
    ...
    return ConvolutionExtrapolation(
        _build_fast_uniform_convolution(knots_t, values,
            ((:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear)), 10000, true,
...
function convolution_interpolation(knots::NTuple{5,AbstractVector}, values::Array{T,5}) where {T}
    ...
    return ConvolutionExtrapolation(
        _build_fast_uniform_convolution(knots_t, values,
            ((:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear)), 10000, true,
...
function convolution_interpolation(knots::NTuple{6,AbstractVector}, values::Array{T,6}) where {T}
    ...
    return ConvolutionExtrapolation(
        _build_fast_uniform_convolution(knots_t, values,
            ((:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear)), 10000, true,
...
function convolution_interpolation(knots::NTuple{7,AbstractVector}, values::Array{T,7}) where {T}
    ...
    return ConvolutionExtrapolation(
        _build_fast_uniform_convolution(knots_t, values,
            ((:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear)), 10000, true,
...
function convolution_interpolation(knots::NTuple{8,AbstractVector}, values::Array{T,8}) where {T}
    ...
    return ConvolutionExtrapolation(
        _build_fast_uniform_convolution(knots_t, values,
            ((:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear)), 10000, true,
...
function convolution_interpolation(knots::NTuple{9,AbstractVector}, values::Array{T,9}) where {T}
    ...
    return ConvolutionExtrapolation(
        _build_fast_uniform_convolution(knots_t, values,
            ((:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear)), 10000, true,
...
function convolution_interpolation(knots::NTuple{10,AbstractVector}, values::Array{T,10}) where {T}
    ...
    return ConvolutionExtrapolation(
        _build_fast_uniform_convolution(knots_t, values,
            ((:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear), (:linear, :linear)), 10000, true,
