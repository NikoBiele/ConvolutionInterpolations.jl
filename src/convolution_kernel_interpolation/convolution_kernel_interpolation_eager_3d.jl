@inline function (itp::ConvolutionInterpolation{T,3,TCoefs,IT,Axs,KA,Val{3},
                    DG,EQ,KBC,DerivativeOrder{DO},FD,SD,SG,NB,Val{false}})(x::Vararg{Number,3}) where 
                    {T,TCoefs,IT,Axs,KA<:Tuple{<:ConvolutionKernel,<:ConvolutionKernel,<:ConvolutionKernel},DG,
                    EQ<:Tuple{Int,Int,Int},KBC,DO,FD,SD,SG,NB<:Nothing}
