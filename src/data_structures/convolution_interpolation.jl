...
struct ConvolutionInterpolation{T,N,NI,TCoefs<:AbstractArray{T,N},
                                Axs<:Tuple,KA,DT,DG,EQ,KBC,DO,FD,SD,SG,NB,LZ,DI,SZ} <: 
                                AbstractConvolutionInterpolation{T,N,NI,TCoefs,
                                Axs,KA,DT,DG,EQ,KBC,DO,FD,SD,SG,LZ,DI,SZ}
    coefs::TCoefs
    domain_size::SZ
    knots::Axs
    h::NTuple{N,T}
