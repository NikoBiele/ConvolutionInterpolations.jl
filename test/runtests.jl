...
function convolution_test()
    ...
    vals_1d_rand = rand(N)
    itp_1d_rand = convolution_interpolation(range_1d, vals_1d_rand; degree=5, extrapolation_bc=Line())
    ...
    itp_1d_linear = convolution_interpolation(range_1d, vals_1d_linear; degree=5, extrapolation_bc=Line())
    @test itp_1d_linear.(range(vals_1d_linear_mean[1], stop=vals_1d_linear_mean[end], length=N-1)) ≈ vals_1d_linear_mean  rtol=0.1

    # extrapolation
    etp_1d_linear = convolution_interpolation(range_1d, vals_1d_linear; degree=5, extrapolation_bc=Line())
    @test etp_1d_linear.([-0.2, -0.1, 1.1, 1.2]) ≈ [-0.2, -0.1, 1.1, 1.2]  rtol=0.1
    etp_1d_flat = convolution_interpolation(range_1d, vals_1d_linear; degree=5, extrapolation_bc=Flat())
    ...
    itp_2d_rand = convolution_interpolation((range_1d, range_2d), vals_2d_rand; degree=5, extrapolation_bc=Line())
    ...
    itp_2d_linear = convolution_interpolation((range_1d, range_2d,), vals_2d_linear; degree=5, extrapolation_bc=Line())
    @test [itp_2d_linear((i-0.5)/(N-1),(j-0.5)/(N-1)) for j in 1:N-1 for i in 1:N-1]'[:] ≈ vals_2d_linear_mean  rtol=0.1

    # extrapolation
    etp_2d_linear = convolution_interpolation((range_1d, range_2d,), vals_2d_linear; degree=5, extrapolation_bc=Line())
    @test [etp_2d_linear(i, i) for i in [-0.2, -0.1, 1.1, 1.2]] ≈ [-0.4, -0.2, 2.2, 2.4]  rtol=0.1
    etp_2d_flat = convolution_interpolation((range_1d, range_2d,), vals_2d_linear; degree=5, extrapolation_bc=Flat())
    ...
    itp_3d_rand = convolution_interpolation((range_1d, range_2d, range_3d), vals_3d_rand; degree=5, extrapolation_bc=Line())
    ...
    itp_3d_linear = convolution_interpolation((range_1d, range_2d, range_3d), vals_3d_linear; degree=5, extrapolation_bc=Line())
    ...
    # extrapolation
    etp_3d_linear = convolution_interpolation((range_1d, range_2d, range_3d), vals_3d_linear; degree=5, extrapolation_bc=Line())
    @test isapprox([etp_3d_linear(i, i, i) for i in [-0.2, -0.1, 1.1, 1.2]], [-0.6, -0.3, 3.3, 3.6], atol=1e-3)  rtol=0.1
    etp_3d_flat = convolution_interpolation((range_1d, range_2d, range_3d), vals_3d_linear; degree=5, extrapolation_bc=Flat())
    ...
    itp_4d_rand = convolution_interpolation((range_1d, range_2d, range_3d, range_4d), vals_4d_rand; degree=5, extrapolation_bc=Line())
    ...
    itp_4d_linear = convolution_interpolation((range_1d, range_2d, range_3d, range_4d), vals_4d_linear; degree=5, extrapolation_bc=Line())
    ...
    etp_4d_linear = convolution_interpolation((range_1d, range_2d, range_3d, range_4d), vals_4d_linear; degree=5, extrapolation_bc=Line())
    @test [etp_4d_linear( i, i, i, i) for i in [-0.2, -0.1, 1.1, 1.2]] ≈ [-0.8, -0.4, 4.4, 4.8]  rtol=0.1
    etp_4d_flat = convolution_interpolation((range_1d, range_2d, range_3d, range_4d), vals_4d_linear; degree=5, extrapolation_bc=Flat())
